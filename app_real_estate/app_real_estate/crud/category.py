...
from app_real_estate.models import Category
from app_real_estate.schemas import (CategorySchema, CategoryCreateSchema, CategoryUpdateSchema,
...
async def read_category_by_id_db(session: AsyncSession, category_id: int) -> CategorySchema | None:
    return await session.get(Category, category_id)


async def create_category_db(session: AsyncSession, category_in: CategoryCreateSchema) -> Category:
