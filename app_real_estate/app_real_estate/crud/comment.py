...
from app_real_estate.schemas import (
    ...
    CommentSchema,
    CommentUpdateSchema, PostBlogSchema, CommentBlogCreateSchema, CommentBlogResponseSchema, CommentAllSchema
)
...
async def create_comment_db(comment_in: CommentBlogCreateSchema, post_id: str) -> CommentBlogResponseSchema:
